...
<html>
 ...
 <%--该页面是首页，首页默认显示数据库所有有效对象，并默认为按照发布时间排序 --%>
...
<!-- 信息列表 -->
        ...
        ArrayList<Notifications> list =sortServlet.OderByNotify_time(nitifiDAO.getSQL());
        int size=list.size();
        if(list!=null&&size>0){
...
<%--循环结束 --%>
    ...
    <div id="pagelist">
    <ul>
    <li><a href="index.jsp?curPage=1">首页</a></li>
    <li><a href="index.jsp?curPage=<%= curPage -1%>">上页</a></li>
	<li class="pageinfo">第<%=curPage %>页</li>
    <li><a href="index.jsp?curPage=<%= curPage +1 %>">下页</a></li>
    <li><a href="index.jsp?curPage=<%= pageCount %>">尾页</a></li>
