...
<!-- 信息列表 -->
		...
		ArrayList<Notifications> list =sortServlet.OderByTime((String)session.getAttribute("searchSQL"));
		int size=list.size();
        if(list!=null&&size>0){
...
<%--循环结束 --%>
     ...
     <div id="pagelist">
    <ul>
    <li><a href="sort3.jsp?curPage=1">首页</a></li>
    <li><a href="sort3.jsp?curPage=<%= curPage -1%>">上页</a></li>
	<li class="pageinfo">第<%=curPage %>页</li>
    <li><a href="sort3.jsp?curPage=<%= curPage +1 %>">下页</a></li>
    <li><a href="sort3.jsp?curPage=<%= pageCount %>">尾页</a></li>
