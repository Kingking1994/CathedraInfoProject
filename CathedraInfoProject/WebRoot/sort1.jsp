...
<div>
    ...
    <div class="first-head-div">
        <div class="second-head-div">
            ...
            <a href="login.jsp" class="website-home">网站首页</a>
...
<!-- 排序表单 -->
        <div class="first-div clearfix unstyled" style="width:200px">
            ...
            <ul class="clearfix unstyled drop-menu">
                <li><a href="servlet/SortServlet?sort=sort2" class="three-d">
                    讲座发布时间优先
                <span class="three-d-box"><span class="front">讲座发布时间优先</span><span class="back">讲座发布时间优先</span></span>
                </a></li>
                <li><a href="servlet/SortServlet?sort=sort1" class="three-d">
                    讲座举行时间优先
...
<!-- 信息列表 -->
        ...
        NotificationsDAO nitifiDAO = new NotificationsDAO();
        ArrayList<Notifications> list =sortServlet.OderByTime(nitifiDAO.getSQL());
        int size=list.size();
        if(list!=null&&size>0){
...
<%--循环结束 --%>
     ...
     <div id="pagelist">
    <ul>
    <li><a href="sort1.jsp?curPage=1">首页</a></li>
    <li><a href="sort1.jsp?curPage=<%= curPage -1%>">上页</a></li>
	<li class="pageinfo">第<%=curPage %>页</li>
    <li><a href="sort1.jsp?curPage=<%= curPage +1 %>">下页</a></li>
    <li><a href="sort1.jsp?curPage=<%= pageCount %>">尾页</a></li>
